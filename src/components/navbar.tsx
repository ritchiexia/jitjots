                                    ...
                                    <Accordion type="single" collapsible>
                                        ...
                                        <AccordionItem value="item-4" className="border-b">
                                            ...
                                            <AccordionContent className="pl-4 flex flex-col gap-2">
                                                ...
                                                <SheetClose asChild>
                                                    <Link href="/contact" className="block py-2 text-sm text-gray-700 hover:text-primary">
                                                        Contact Us
                                                    </Link>
                                                </SheetClose>
                                            </AccordionContent>
                            ...
                            <div className="relative group/involved">
                                ...
                                <div className="absolute top-full left-0 pt-1 hidden group-hover/involved:block z-50">
                                    <div className="bg-white rounded-md border shadow-lg p-2 min-w-[200px]">
                                        ...
                                        <Link href="/contact" className="block px-3 py-2 text-sm text-gray-800 hover:bg-slate-100 rounded-md">Contact Us</Link>
                                    </div>
                                </div>
                            </div>
